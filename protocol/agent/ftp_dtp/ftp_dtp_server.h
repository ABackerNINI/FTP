...
#define FTP_DTP_TYPE_SERVER_PASSIVE_SEND    0
#define FTP_DTP_TYPE_SERVER_PASSIVE_RECV    1
#define FTP_DTP_TYPE_SERVER_ACTIVE_SEND     2
#define FTP_DTP_TYPE_SERVER_ACTIVE_RECV     3

namespace ftp_dtp {
    static network::ServerConfig *_server_config;

    class _ftp_dtp_server_passive_send : public network::Server {
    public:
        _ftp_dtp_server_passive_send(const char *fpath, unsigned int *local_port, HANDLE completion_port_2, SOCKET sockid_2);
    ...
    class _ftp_dtp_server_passive_recv : public network::Server {
    public:
        _ftp_dtp_server_passive_recv(const char *fpath, unsigned int *local_port, HANDLE completion_port_2, SOCKET sockid_2);
    ...
    class _ftp_dtp_server_active_send : public network::Client {
    public:
        _ftp_dtp_server_active_send(const char *fpath, const char *addr, unsigned int port, HANDLE completion_port_2, SOCKET sockid_2);
    ...
    class _ftp_dtp_server_active_recv : public network::Client {
    public:
        _ftp_dtp_server_active_recv(const char *fpath, const char *addr, unsigned int port, HANDLE completion_port_2, SOCKET sockid_2);
