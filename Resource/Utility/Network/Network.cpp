...
bool network::Server::_DoAccept(SVR_SOCKET_CONTEXT *_SocketContext) {
	...
	_Call(_SocketContext->m_ClientSocket, SVR_EV::SVREV_ACCEPTED, (void *)_SocketContext);
...
#endif
	_Call(_SocketContext->m_ClientSocket, SVR_EV::SVREV_RECVD, (void *)_SocketContext);
...
#endif
	_Call(_SocketContext->m_ClientSocket, SVR_EV::SVREV_SENT, (void *)_SocketContext);
